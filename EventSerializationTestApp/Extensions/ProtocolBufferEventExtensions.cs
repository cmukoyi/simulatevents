...
namespace EventSerializationTestApp.Extensions
{
	public static class ProtocolBufferEventExtensions
	{
		private const string Specified = "Specified";

		private static readonly IList<string> IgnoreProperties = new[] { "Header" };
		...
		/// <param name="ev"></param>
		/// <returns></returns>
		public static IList<KeyValuePair<string, string>> ToPropertyNameAndStringValueList(this object ev)
		{
		...
		/// <summary>
		/// Get event header or null
		/// </summary>
		/// <param name="ev"></param>
		/// <returns></returns>
		public static EventHeader GetEventHeader(this object ev)
		{
			PropertyInfo propertyInfo = ev.GetType().GetProperty("Header", typeof(EventHeader));
			return (propertyInfo != null)
				? propertyInfo.GetValue(ev) as EventHeader
				: null;
		}
	}
}
